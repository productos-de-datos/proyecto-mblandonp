""" 
Módulo para promediar precios diarios. 
------------------------------------------------------------------------------- 
Del archivo data_lake/cleansed/precios-horarios.csv se transforma la columna fecha  
en formato datetime, y se genera por cada fecha el precio promedio diario guardando  
el archivo en la ruta data_lake/business/precios-diarios.csv. 
...
def average_daily_price(file):
    ...
    compute_daily_prices = subset_file.groupby("fecha").mean({"precio": "precio"})
